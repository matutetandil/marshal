...
Work begins on `0.2.0` — first slice of Phase 1 (command interception with
pass-through default, modernization suggestions, improved status output).
...
[Unreleased]: https://github.com/matutetandil/marshal/compare/v0.1.0...HEAD
