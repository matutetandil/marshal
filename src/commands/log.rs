...
//! manifest and state.toml over time). Inside a child repo: delegates to
//! normal git log for that repo.
//!
//! Scaffolded for Phase 2; not wired from `main` in 0.2.0. Forwards to git
//! via passthrough so the scaffold stays compilable and honest until the
